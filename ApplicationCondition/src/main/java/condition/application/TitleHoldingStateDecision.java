...
public class TitleHoldingStateDecision implements java.io.Serializable {

    static final long serialVersionUID = 1L;

    public TitleHoldingStateDecision() {
    }
   ...
   public TitleHoldingStateDecision(java.lang.String transactionType,
