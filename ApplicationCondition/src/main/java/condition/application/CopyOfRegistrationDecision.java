...
public class CopyOfRegistrationDecision implements java.io.Serializable
{

   static final long serialVersionUID = 1L;

   public CopyOfRegistrationDecision()
   {
   }
   ...
   public CopyOfRegistrationDecision(java.lang.String transactionType,
